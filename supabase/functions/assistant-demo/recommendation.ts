...
// logic path. This is a verbatim copy of ../assistant/recommendation.ts — this function is a
// separate Supabase Edge Function deploy unit (own files array), so it can't import across
// function directories; if you change the weights/thresholds here, change them in
// ../assistant/recommendation.ts and src/utils/ too.
